...
const Services = ({ model }) => {
    ...
    return (
        <div className={cx(['services', 'mask relative bg-bottom md:px-[60px] py-8 px-4'])} style={{ backgroundImage: `url(${model?.backgroundImage?.sourceUrl})` }}>
                ...
                <Container>
                    ...
                    >
                        {model.services.map((slide, i) => (
                            <SwiperSlide key={'service-' + i} className='overflow-hidden flex justify-center pb-8'>
                                <div className='bg-white w-full max-w-[330px] rounded-[10px] shadow-lg'>
